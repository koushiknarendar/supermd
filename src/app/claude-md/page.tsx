...
const CLAUDEIGNORE = `# .claudeignore — tells Claude Code never to read these files
# Generated by SuperMD · supermd.dev/claude-md
...
# Build output (rarely useful for Claude)
dist/
.next/
out/
build/
            ...
            {status === "done" && output ? (
              <>
                ...
                <OutputCard
                  ...
                  label=".claudeignore — blocks secrets from Claude"
                />
              </>
            ) : (
